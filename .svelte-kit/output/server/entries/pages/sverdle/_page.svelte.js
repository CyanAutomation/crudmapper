import { h as head, c as attr, b as attr_class, a as ensure_array_like, e as escape_html, j as clsx, d as stringify, k as derived } from "../../../chunks/index2.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<h1 class="visually-hidden svelte-115oxdy">Sverdle</h1> <form method="post" action="?/enter" class="svelte-115oxdy"><a class="how-to-play svelte-115oxdy"${attr("href", resolve("/sverdle/how-to-play"))}>How to play</a> <div${attr_class("grid svelte-115oxdy", void 0, { "playing": !won(), "shake": shake })}><!--[-->`);
